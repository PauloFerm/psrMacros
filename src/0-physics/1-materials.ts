...
export namespace Material {
  ...
  export const elastomericFoam: material = {
    name: "Elastomeric Foam",
    thermalConductivity: 0.031,
  };
  export const plasterboard: material = {
    name: "Plasterboard",
    thermalConductivity: 0.26,
  };
  export const fibreCement: material = {
    name: "Fibre Cement",
    thermalConductivity: 1,
  };
  export const instapanel: material = {
    name: "Instapanel",
    thermalConductivity: 0.4,
  };
  export const vulcanite: material = {
    name: "Vulcanite",
  ...
  export const aluminum: material = {
    name: "Aluminum",
    thermalConductivity: 209,
  };
  export const plywood: material = {
    name: "Plywood",
  ...
  export const epe: material = {
    name: "Expanded Poliethilene",
    thermalConductivity: 0.034,
  };
  export const clt: material = {
    name: "Cross Laminated Timber",
    thermalConductivity: 0.153,
  };
}
